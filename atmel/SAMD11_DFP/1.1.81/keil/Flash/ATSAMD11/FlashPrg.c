 ...
 * $Revision:    V1.00
 *  
 * Project:      Flash Programming Functions for ATSAMD11
 * --------------------------------------------------------------------------- */
...
/* ---- SAM D11 ------------------------------------------------------------------*/
#if defined ATSAMD11_16 || defined ATSAMD11_8
  #define PAC0_BASE            0x40000000
  #define PAC1_BASE            0x41000000
  #define NVMCTRL_BASE         0x41004000        /* SAMD10                     */
#endif

#if defined ATSAMD11_16
  #define FLASH_SIZE           0x04000
#endif

#if defined ATSAMD11_8
  #define FLASH_SIZE           0x02000
#endif
